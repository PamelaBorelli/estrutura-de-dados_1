...
class DoublyLinkedList:
    ...
    def remove(self, pos):
        ...
        # 4º caso: remoção em posição intermediária
            ...
            # o nodo anterior passa a apontar, à frente, para nodo posteior
            before.next = after
    ...
    ''' Método de atalho para remoção da final'''
    ...
    ''' Método de atalho para consultar a primeiro nodo'''
    def peek_front(self):
        return self.peek(0)

    ''' Método de atalho para consultar o ultimo nodo'''
    def peek_back(self):
